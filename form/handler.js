...
function updateCountryCode(
    ...
    try {
        ...
        if (phoneInput.iti && typeof phoneInput.iti.getSelectedCountryData === 'function') {
  ...
  function validateForm() {
    ...
    if (typeof window.validatePhone !== 'function') {
      console.error("validatePhone function not found. Is the phone validator library loaded?");
      return false;
    }
    ...
    if (!validation.isValid) {
      ...
      if (phoneError) {
        ...
        phoneError.textContent = validation.message || "Please enter a valid phone number";
      }
  ...
  function handleRedirection() {
    if (!window.redirectionOptions || !window.redirectionOptions.type) {
      console.error("window.redirectionOptions not found or missing type property");
      return;
    }
    ...
    switch (window.redirectionOptions.type) {
      ...
      case "webflow":
        ...
        break;
      default:
        console.error("Invalid redirection type:", window.redirectionOptions.type);
        return;
    }
  }
